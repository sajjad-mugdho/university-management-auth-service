...
router.patch('/:id', (0, validateRequest_1.default)(student_validation_1.StudentValidaion.updateStudentZodSchema), student_contoller_1.StudentController.updateStudent);
