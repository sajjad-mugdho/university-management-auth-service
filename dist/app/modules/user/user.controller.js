...
const createStudent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { student } = _a, studentData = __rest(_a, ["student"]);
    console.log('data:', studentData);
    const result = yield user_service_1.UserService.createStudent(student, studentData);
...
const createAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _c = req.body, { admin } = _c, adminData = __rest(_c, ["admin"]);
    console.log('data:', adminData);
    const result = yield user_service_1.UserService.createFaculty(admin, adminData);
    console.log('result:', result);
    //
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
