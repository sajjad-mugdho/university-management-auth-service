...
exports.ManagementDepartmanetService = void 0;
...
const createDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield managementDepartment_model_1.ManagementDepartmanet.create(payload);
    return result;
});
const getSingleDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield managementDepartment_model_1.ManagementDepartmanet.findById(id);
    return result;
});
const getAllDepartments = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield managementDepartment_model_1.ManagementDepartmanet.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
    const total = yield managementDepartment_model_1.ManagementDepartmanet.countDocuments();
    return {
        meta: {
            page,
            limit,
...
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield managementDepartment_model_1.ManagementDepartmanet.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield managementDepartment_model_1.ManagementDepartmanet.findByIdAndDelete(id);
    return result;
});
exports.ManagementDepartmanetService = {
    createDepartment,
    getAllDepartments,
    deleteDepartment,
    updateDepartment,
